...
namespace DuloGames.UI
{
    ...
    {
        public UILoadScene loadscene_script;
        [System.Serializable]
        ...
        [SerializeField] private int m_AddCharacters = 3;
        ...
        protected void Start()
        {
            ...
            if (this.m_IsDemo && this.m_CharacterPrefab)
            {
                ...
                {
                    string[] names = new string[3] {"ACIENT CITY", "AGE CITY", "MORDEN CITY"};
        ...
        {
            Debug.Log(character.characterInfo.level);
            loadscene_script.setLevelNubmer(character.characterInfo.level);
